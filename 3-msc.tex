...
\begin{frame}{}
    ...
    \only<7>{\centering Então, ${\color{blue} \cals}$ é válido.}
    \only<8>{\centering Portanto, pelo \ref{lemma:1}º Lema, o custo de ${\color{blue} \cals}$ é no máximo $2\floor{\nicefrac{t^*}{\theta}}\theta \le 2t^*$ \\\qed}

    \begin{minipage}{\linewidth}
        \vspace*{0.5cm}
        \centering
        \only<2>{\includegraphics[height=6cm]{MSC/end/end_2.png}}%
        \only<3>{\includegraphics[height=6cm]{MSC/end/end_3.png}}%
        \only<4-6>{\includegraphics[height=6cm]{MSC/end/end_4.png}}%
    \end{minipage}
\end{frame}
