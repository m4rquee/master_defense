...
\begin{frame}{}
    \centering
    Particionamos o intervalo de tempo $[0,\ \theta (N+1))$:
...
\begin{frame}{}
    ...
    \centering 
    \only<2>{Seja $\cals^*$ uma solução ótima para $\cali$.}
...
\begin{frame}{}
    ...
    \begin{minipage}{\linewidth}
        \vspace*{2cm}
        \centering
        \only<2>{\includegraphics[width=10cm]{MSC/lemma/lema_3.png}}%
        \only<3>{\includegraphics[width=10cm]{MSC/lemma/lema_4.png}\qed}%
    \end{minipage}
\end{frame}
